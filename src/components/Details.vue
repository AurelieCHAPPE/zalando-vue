...
const emit = defineEmits([
  'changeSelectedVariant', // Pas besoin de vérification à l'évènement
  'addProductToCart',
])
  ...
  <div>
    ...
    <div class="sizes-bloc">
      <div
        ...
        @click="handleSelectedSize(size, quantity)"
      >
        {{ size }}
      </div>
    </div>
...
.cart-bloc button {
  font-family: inherit; /* prendre la police de son parent */
  font-size: inherit;
  font-weight: bold;
  background-color: var(--main-black);
  color: white;
  flex: 1; /* prendre toute la place dispo */
  cursor: pointer; /*mettre la main*/
  border: none;
}
